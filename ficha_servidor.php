                ...
                <div class="row form-group border border-dark " style="background-color:#ECF4FE;">
                    ...
                    <div class="form-group col-md-4" align="left">
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            <input class='form-check-input' name='ilustracao' type='checkbox' value='1' id='defaultCheck1'>
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            <input class='form-check-input' name='bibliografia' type='checkbox' value='1' id='defaultCheck1'>
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            <input class='form-check-input' name='anexo' type='checkbox' value='1' id='defaultCheck1'>
                        ...
                        <div class="form-check form-check-inline">
                            <input class='form-check-input' name='apendice' type='checkbox' value='1' id='defaultCheck1'>
                        </div>
